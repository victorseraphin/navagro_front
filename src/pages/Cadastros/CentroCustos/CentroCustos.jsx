...
import FormCentroCustos from "./FormCentroCustos";
    ...
    return (
        <div className="p-4 px-8 max-w-full mx-auto">
            ...
            <div className="mb-6 border border-gray-300 rounded bg-gray-50 p-4 shadow-sm">
                <h2 className="font-semibold text-xl mb-4 text-gray-700">Centro de Custos</h2>
            ...
            {exibindoFormulario && (
                <FormCentroCustos onSalvar={salvarFormulario} onCancelar={cancelarModal} />
            )}
        </div>
    );
}
