...
export default function FormClienteFornecedor({ onSalvar, onCancelar }) {
    ...
    return (
        <div className="fixed inset-0 z-50 bg-white flex flex-col overflow-auto">
            ...
            <div className="flex items-center justify-between px-4 py-3 border-b shadow-sm sticky top-0 bg-black-50 z-10 text-white">
                ...
                {/* Título centralizado */}
                <h2 className="text-base font-semibold text-white">Clientes / Fornecedores</h2>
