...
import FormClienteFornecedor from "./FormClienteFornecedor";
    ...
    return (
        <div className="p-4 px-8 max-w-full mx-auto">
            ...
            <div className="mb-6 border border-gray-300 rounded bg-gray-50 p-4 shadow-sm">
                <h2 className="font-semibold text-xl mb-4 text-gray-700">Clientes / Fornecedores</h2>
            ...
            {exibindoFormulario && (
                <FormClienteFornecedor onSalvar={salvarFormulario} onCancelar={cancelarModal} />
            )}
        </div>
    );
}
